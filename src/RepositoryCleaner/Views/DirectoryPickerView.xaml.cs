// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DirectoryPickerView.xaml.cs" company="CatenaLogic">
...
namespace RepositoryCleaner.Views
{
    ...
    public partial class DirectoryPickerView
    {
        ...
        public static readonly DependencyProperty LabelWidthProperty = DependencyProperty.Register(nameof(LabelWidth), typeof (double), typeof (DirectoryPickerView), new PropertyMetadata(125d));
        ...
        public static readonly DependencyProperty LabelTextProperty = DependencyProperty.Register(nameof(LabelText), typeof (string), typeof (DirectoryPickerView), new PropertyMetadata(string.Empty));
